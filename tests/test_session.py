...
def test_update_session_changes_session_data(database_path: Path, test_data: list[dict]) -> None:
    create_test_sessions(database_path, test_data)
...
def test_delete_session_deletes_session_data(database_path: Path, test_data: list[dict]) -> None:
    create_test_sessions(database_path, test_data)
